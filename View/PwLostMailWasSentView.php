...
class PwLostMailWasSentView extends \LWmvc\View\View
{
    ...
    {
        if($this->lang == "de"){
            $view = new \lw_view(dirname(__FILE__).'/Templates/de/PwLostEmailWasSent.phtml');
        }else{
            $view = new \lw_view(dirname(__FILE__).'/Templates/en/PwLostEmailWasSent.phtml');
        }
